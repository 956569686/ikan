...
internal constructor(private val apiConnector: Connector, private val tokenCache: TokenCache) {
    ...
    fun createLocalDataStore(): TokenDataStore {
        return LocalTokenDataStore(tokenCache)
    }

    fun createCloudDataStore(): TokenDataStore {
        return CloudTokenDataStore(apiConnector, tokenCache)
    }
}
