...
public abstract class SimpleDialogFragment extends DialogFragment {
    ...
    protected static final String K_ID = "lingban.dialog.id";
    protected static final String K_TITLE = "lingban.dialog.title";
    protected static final String K_MESSAGE = "lingban.dialog.message";
    protected static final String K_HINT = "lingban.dialog.hint";
    protected static final String K_POSITIVE = "lingban.dialog.positive";
    protected static final String K_NEGATIVE = "lingban.dialog.negative";
    protected static final String K_ACTION_ABOVE = "lingban.dialog.action.above";
    protected static final String K_ACTION_MIDDLE = "lingban.dialog.action.middle";
    protected static final String K_ACTION_BELOW = "lingban.dialog.action.below";
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        TextView vCancel = (TextView) view.findViewById(R.id.cancel);
        if (null != vCancel) {
