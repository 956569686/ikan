...
public final class TableRow extends RelativeLayout {
    ...
    private void bindViewAttrs(TypedArray typedArray) {
        ...
        primaryTitleSize = typedArray.getDimensionPixelSize(R.styleable.table_row_primary_title_size, IN_VALID_RES_ID);
        secondaryTitleSize = typedArray.getDimensionPixelSize(R.styleable.table_row_secondary_title_size, IN_VALID_RES_ID);
    ...
    private void bindViewAttrsValue() {
        ...
        if (primaryTitleSize != IN_VALID_RES_ID) {
            primaryTitle.setTextSize(TypedValue.COMPLEX_UNIT_SP, primaryTitleSize);
        }

        if (secondaryTitleSize != IN_VALID_RES_ID) {
            secondaryTitle.setTextSize(TypedValue.COMPLEX_UNIT_SP, secondaryTitleSize);
        }
