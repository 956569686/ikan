...
public final class AlertDialogFragment extends DialogFragment {
    ...
    public static class Builder extends DialogBuilder {
        ...
        public Builder setTitle(int title) {
            this.data.putInt(KEY_TITLE, title);
            return this;
        }

        public static int getTitle(Bundle args) {
            return args.getInt(KEY_TITLE, 0);
        }
        ...
        public Builder setMessage(int id) {
            this.data.putInt(KEY_MESSAGE, id);
            return this;
        }

        public static int getMessage(Bundle args) {
            return args.getInt(KEY_MESSAGE, 0);
        }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        int titleId = Builder.getTitle(args);
        if (titleId > 0) {
            vTitle.setText(getString(titleId));
        }

        TextView vMessage = (TextView) view.findViewById(R.id.message);
        int messageId = Builder.getMessage(args);
        if (messageId > 0) {
            vMessage.setText(getString(messageId));
        }
